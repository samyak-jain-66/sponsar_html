...
function Home(){
    ...
    return(
        <div>
            {/* It contains basically the navbar and the showcase content and they both put it in single container named showcase  */}
            <header id="showcase">
            ...
            {/* This section basically contains cards which represent the No of events in each category just below the showcase content  */}
            <div id="mini-card">
            ...
            {/* This section basically contains the cards which has details about the each event upcoming in the future  */}
            <div id="upcoming-events">
                <h1 className="large-heading">Upcoming Events</h1>
                <p className="large-paragraph"> You can choose to display featured</p>
                <Slider/>
            </div>
            {/* This is basically a how section on homepage just below upcoming events */}
            <div className="how">
            ...
            {/* Subscribe section just below blog section */}
            ...
            {/* This is another foooter which basically contain copyright and Privacy policy */}
